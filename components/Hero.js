      ...
      <div className='container grid grid-cols-5 z-10'>
        <div className='flex-1 flex flex-col justify-center col-span-3'>
          <div className=''>
            ...
            <p className='text-lg mt-6 font-normal max-w-[600px]'>
              Enterpreneur (wirausahawan), akademisi atau berkarier di instansi
              pemerintah dan swasta sebagai manajer yang profesional dan ahli di
              bidang pemasaran, keuangan, manajemen sumber daya manusia,
              produksi dan operasional pada perusahaan manufaktur, perusahaan
              jasa, rumah sakit, hotel, perbankan, pendidikan, teknologi
              informasi, komunikasi, pegawai bank, dan lain-lain.
            </p>
